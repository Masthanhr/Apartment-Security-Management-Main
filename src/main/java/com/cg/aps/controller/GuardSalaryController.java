...
public class GuardSalaryController {
	...
	@PostMapping
	public ResponseEntity<Object> addGuardSalaryReq(GuardSalaryEntity guard) {
	...
	@PutMapping("/{userId}")
	public ResponseEntity<Object> updateGuardSalaryReq(@PathVariable("userId") long userId,@RequestBody GuardSalaryEntity guard) {
	...
	@GetMapping(value = "/namesalary/{name}")
