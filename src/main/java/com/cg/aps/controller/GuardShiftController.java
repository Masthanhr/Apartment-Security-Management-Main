...
public class GuardShiftController {
	...
	@PostMapping
	public ResponseEntity<Object> addGuardShiftReq(GuardShiftEntity guard) {
	...
	@PutMapping("/{userId}")
	public ResponseEntity<Object> updateGuardShiftReq(@PathVariable("userId") long userId,@RequestBody GuardShiftEntity guard) {
	...
	@GetMapping(value = "/nameshift/{name}")
