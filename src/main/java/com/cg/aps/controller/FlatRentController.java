...
public class FlatRentController {
	...
	public ResponseEntity<Object> getRent(@PathVariable("userId") int userId) {
		...
		FlatRentEntity rent = flatRentService.getFlatRentEntity(userId);
	...
	public ResponseEntity<Object> getRentOwner(@PathVariable("ownerName") String ownerName) {
		...
		FlatRentEntity rent1 = flatRentService.getRentOwner(ownerName);
	...
	@PutMapping("/{userId}")
	public ResponseEntity<Object> updateFlatRent(@PathVariable("userId") int userId,
