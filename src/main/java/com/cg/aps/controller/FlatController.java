...
public class FlatController {
	...
	public ResponseEntity<Object> getflat(@PathVariable("userId") int userId) {
		...
		if (flat == null) {
			...
			throw new FlatIdNotFoundException(userId + " Not Found");
	...
	// INSERT USING POST
	@PostMapping
	public ResponseEntity<Object> addflat(@Valid @RequestBody FlatEntity flat2) {
	...
	public ResponseEntity<Object> deleteflat(@PathVariable("userId") int id) {
	...
	@PutMapping("/{userId}")
	public ResponseEntity<Object> updateflat(@PathVariable("userId") int userId, @RequestBody FlatEntity flat3) {
		flat3.setUserId(userId);
	...
	@GetMapping("/page")
	public ResponseEntity<List<FlatEntity>> getPageFlats(@RequestParam(defaultValue = "0") Integer pageNo,
